...
/**
 * Resource representing a tool.
 *
 * @author Myriam Leggieri.
 *
 */
public class ToolResource extends LiSeDToolResource {

  public ToolResource(Context context, Request request, Response response) {
  ...
  public Representation represent(Variant variant) {
    ...
    if (media.equals(MediaType.APPLICATION_ALL) || media.equals(MediaType.TEXT_ALL)
      ...
      try {
        ...
        logRequest(resourceName, toolname);
