...
/**
 * Resource representing a programming language.
 *
 * @author Myriam Leggieri.
 *
 */
public class LanguageResource extends LiSeDLanguageResource {

  public LanguageResource(Context context, Request request, Response response) {
  ...
  public Representation represent(Variant variant) {
    ...
    if (media.equals(MediaType.APPLICATION_ALL) || media.equals(MediaType.TEXT_ALL)
      ...
      try {
        ...
        logRequest(resourceName, languageName);
