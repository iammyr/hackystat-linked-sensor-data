...
/**
 * Resource representing a machine.
 *
 * @author Myriam Leggieri.
 *
 */
public class MachineResource extends LiSeDMachineResource {

  public MachineResource(Context context, Request request, Response response) {
  ...
  public Representation represent(Variant variant) {
    ...
    if (media.equals(MediaType.APPLICATION_ALL) || media.equals(MediaType.TEXT_ALL)
      ...
      try {
        ...
        logRequest(resourceName, machineName);
